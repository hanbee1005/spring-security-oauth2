...
public class GitHubAuthorizationFilter extends GenericFilterBean {
    private static final String AUTHORIZATION_REQUEST_URL = "/login/oauth2/code/github";
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        try {
            String accessToken = githubHttpClient.getAccessToken(request.getParameter("code"));
            GithubUserProfileResponse profile = githubHttpClient.requestUserProfile(accessToken);
